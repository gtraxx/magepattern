...
namespace cssSelector\XPath\Extension;

use cssSelector\Exception\ExpressionErrorException;
use cssSelector\Exception\SyntaxErrorException;
use cssSelector\Node\FunctionNode;
use cssSelector\Parser\Parser;
use cssSelector\XPath\Translator;
use cssSelector\XPath\XPathExpr;
