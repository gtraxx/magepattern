...
class EscapeTool
{
     ...
     * @return string
     */
    public static function unix_separator(): string
    {
        return DIRECTORY_SEPARATOR == '\\' ? str_replace('\\','/',DIRECTORY_SEPARATOR) : DIRECTORY_SEPARATOR;
    }
     ...
     * @return string
     */
    public static function win_separator(): string
    {
        return DIRECTORY_SEPARATOR == '/' ? str_replace('/','\\',DIRECTORY_SEPARATOR) : DIRECTORY_SEPARATOR;
    }
     ...
     * @return string
     */
    public static function convertASCII(string $str): string
    {
        return ord($str);
    }
     ...
     * @return string
     */
    public static function decodeASCII(string $str): string
    {
        return chr($str);
    }
    ...
    public static function decode_utf8(string $str): string
    {
        ...
        $replace = ['A', 'A', 'A', 'A', 'A', 'A', 'AE', 'A', 'A',
            ...
            'c', 't', 'y', 'o', 'x', 'u', 'u', 'w', 'w', 'b', 'b', 'b', 'e', 'o', 'r'];
        return str_replace($accented, $replace, $str);
    }
}